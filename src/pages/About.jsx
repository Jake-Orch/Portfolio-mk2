        ...
        <section className="flex justify-around items-center flex-col sm:flex-row px-5 sm:px-10">
          <section>
            ...
            <img
              src={Profile}
              alt="portrait"
              className="mb-5 sm:mb-0 sm:mr-10"
            ></img>
          </section>
          <section className="w-5/6">
            ...
            <p>
              ...
              Full Stack Web Developer bootcamp. Throughout my time learning Web
              Development, I have created many front end, back end and full
              stack applications. I am enjoying the journey of learning web
              devlopment and looking forward to future endevours in the industry
            </p>
            <p></p>
          </section>
        </section>
