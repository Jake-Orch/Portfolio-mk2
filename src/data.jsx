...
// Here im defining all of the data for my project components
...
// Here im defining all of the data for my skills to be used in the resume page
export const skills = [
  {
    id: 1,
    title: "HTML",
...
// Here im defining all of the data for my attributes, to be used in the about page
